...
function $65ab70ddbed1564b$export$e51a686c67fdaa2d(props) {
    ...
    const { isQuiet: isQuiet , density: density , isDisabled: isDisabled , isEmphasized: isEmphasized , orientation: orientation  } = tabProps;
...
function $65ab70ddbed1564b$var$TabPicker(props) {
    let { isDisabled: isDisabled , isEmphasized: isEmphasized , isQuiet: isQuiet , state: state , 'aria-labelledby': ariaLabeledBy , 'aria-label': ariaLabel , density: density , className: className , id: id  } = props;
    let ref = $cLzzU$useRef();
