...
$ce42e12d543b7e38$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {التاريخ} other {التواريخ}} المحدد/المحددة غير متوفرة.\"}");


var $cf1746301f7b3a2c$exports = {};
$cf1746301f7b3a2c$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Избраната дата не е налична} other {Избраните дати не са налични}}.\"}");


var $2314514bf1e3a606$exports = {};
$2314514bf1e3a606$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Vybrané datum není} other {Vybraná data nejsou}} k dispozici.\"}");


var $949c212f0c3f109b$exports = {};
$949c212f0c3f109b$exports = JSON.parse("{\"invalidSelection\":\"Valgte {selectedCount, plural, one {dato} other {datoer}} ikke ledige.\"}");


var $7fd2c2494bdbc301$exports = {};
$7fd2c2494bdbc301$exports = JSON.parse("{\"invalidSelection\":\"Ausgewählte(s) {selectedCount, plural, one {Datum} other {Daten}} nicht verfügbar.\"}");


var $09ce79b5edaa2da5$exports = {};
$09ce79b5edaa2da5$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Η επιλεγμένη ημερομηνία δεν είναι διαθέσιμη} other {Οι επιλεγμένες ημερομηνίες δεν είναι διαθέσιμες}}.\"}");
...
$f225659383b6c49c$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {La fecha seleccionada no está disponible} other {Las fechas seleccionadas no están disponibles}}.\"}");


var $c33e8e5f03cbf661$exports = {};
$c33e8e5f03cbf661$exports = JSON.parse("{\"invalidSelection\":\"Valitud {selectedCount, plural, one {kuupäev} other {kuupäevad}} pole saadaval.\"}");


var $c4cafdbad7206639$exports = {};
$c4cafdbad7206639$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Valittu päivämäärä ei ole} other {Valitut päivämäärät eivät ole}} saatavilla.\"}");


var $a99d0002fed1587c$exports = {};
$a99d0002fed1587c$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {La date sélectionnée est indisponible} other {Les dates sélectionnées sont indisponibles}}.\"}");


var $da92e613c17f6315$exports = {};
$da92e613c17f6315$exports = JSON.parse("{\"invalidSelection\":\"נבחר {selectedCount, plural, one {תאריך} other {תאריכים}} אינו זמין.\"}");


var $813c89c3343bf5d8$exports = {};
$813c89c3343bf5d8$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Odabrani datum nije dostupan} other {Odabrani datumi nisu dostupni}}.\"}");


var $e55eca3816269da0$exports = {};
$e55eca3816269da0$exports = JSON.parse("{\"invalidSelection\":\"A kijelölt {selectedCount, plural, one {dátum nem érhető el} other {dátumok nem érhetőek el}}.\"}");


var $5bc7943c70fea77d$exports = {};
$5bc7943c70fea77d$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Data selezionata non disponibile} other {Date selezionate non disponibili}}.\"}");


var $a229bcf1010fe509$exports = {};
$a229bcf1010fe509$exports = JSON.parse("{\"invalidSelection\":\"選択した{selectedCount, plural, one {日付} other {日付}}は使用できません。\"}");


var $7a29f4d5c7513499$exports = {};
$7a29f4d5c7513499$exports = JSON.parse("{\"invalidSelection\":\"선택한 {selectedCount, plural, one {일자를} other {일자를}} 사용할 수 없습니다.\"}");


var $cc5486cad5241d94$exports = {};
$cc5486cad5241d94$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Datos} other {Datų}} pasirinkimas negalimas.\"}");


var $c1c7136afde04f9d$exports = {};
$c1c7136afde04f9d$exports = JSON.parse("{\"invalidSelection\":\"Atlasītais(-ie) {selectedCount, plural, one {date} other {dates}} nav pieejams(-i).\"}");


var $136b7b39137652a0$exports = {};
$136b7b39137652a0$exports = JSON.parse("{\"invalidSelection\":\"Valgt(e) {selectedCount, plural, one {dato} other {datoer}} er utilgjengelig.\"}");


var $12ce1e87f3d70b90$exports = {};
$12ce1e87f3d70b90$exports = JSON.parse("{\"invalidSelection\":\"Geselecteerde {selectedCount, plural, one {datum} other {datums}} niet beschikbaar.\"}");


var $85cf17eb58ae9432$exports = {};
$85cf17eb58ae9432$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Wybrana data jest niedostępna} other {Wybrane daty są niedostępne}}.\"}");


var $26ac8703247f4b49$exports = {};
$26ac8703247f4b49$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Data} other {Datas}} selecionada(s) indisponível(is).\"}");


var $5afb437497ade41d$exports = {};
$5afb437497ade41d$exports = JSON.parse("{\"invalidSelection\":\"A(s) {selectedCount, plural, one {data} other {datas}} selecionada(s) não está(ão) disponível/disponível(eis).\"}");


var $db350c958ef4beb2$exports = {};
$db350c958ef4beb2$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Data selectată nu este disponibilă} other {Datele selectate nu sunt disponibile}}.\"}");


var $77640ce2df581e8d$exports = {};
$77640ce2df581e8d$exports = JSON.parse("{\"invalidSelection\":\"Выбранные {selectedCount, plural, one {дата} other {даты}} недоступны.\"}");


var $fdbb191ea38137b2$exports = {};
$fdbb191ea38137b2$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Vybratý dátum} other {Vybraté dátumy}}: nedostupné.\"}");


var $c0a1d77780011254$exports = {};
$c0a1d77780011254$exports = JSON.parse("{\"invalidSelection\":\"Izbrano {selectedCount, plural, one {date} other {dates}} ni na voljo.\"}");


var $178eeb83a4f423ba$exports = {};
$178eeb83a4f423ba$exports = JSON.parse("{\"invalidSelection\":\"Izabrani {selectedCount, plural, one {date} other {dates}} nije dostupan.\"}");


var $2d462724002952ef$exports = {};
$2d462724002952ef$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Valt datum är inte tillgängligt.} other {Valda datum är inte tillgängliga.}}\"}");


var $b81def5695dcf161$exports = {};
$b81def5695dcf161$exports = JSON.parse("{\"invalidSelection\":\"Seçilen {selectedCount, plural, one {tarih} other {tarihler}} müsait değil.\"}");


var $15cf3fb890bd15fc$exports = {};
$15cf3fb890bd15fc$exports = JSON.parse("{\"invalidSelection\":\"{selectedCount, plural, one {Вибрана дата недоступна} other {Вибрані дати недоступні}}.\"}");


var $7e919322f8380a78$exports = {};
$7e919322f8380a78$exports = JSON.parse("{\"invalidSelection\":\"选定的 {selectedCount, plural, one {个日期} other {个日期}} 不可用。\"}");


var $fdf4dbfb11dfcef7$exports = {};
$fdf4dbfb11dfcef7$exports = JSON.parse("{\"invalidSelection\":\"所選的{selectedCount, plural, one {日期} other {日期}}無法使用。\"}");
...
function $6d416018158e3a26$export$bfd52a43017368fe(props) {
    ...
    let formatMessage = $4BAFd$reactariai18n.useMessageFormatter((/*@__PURE__*/$parcel$interopDefault($b2ddf7aa92a6115d$exports)));
    ...
    }, /*#__PURE__*/ ($parcel$interopDefault($4BAFd$react)).createElement($4BAFd$reactariavisuallyhidden.VisuallyHidden, null, /*#__PURE__*/ ($parcel$interopDefault($4BAFd$react)).createElement("h2", null, calendarProps['aria-label'])), /*#__PURE__*/ ($parcel$interopDefault($4BAFd$react)).createElement("div", {
...
function $d9490b77e8681e44$var$Calendar(props, ref) {
    ...
    $4BAFd$react.useImperativeHandle(ref, ()=>({
            ...$4BAFd$reactspectrumutils.createDOMRef(domRef),
            focus () {
...
function $4d045066f2092e3b$var$RangeCalendar(props, ref) {
    ...
    let { calendarProps: calendarProps , prevButtonProps: prevButtonProps , nextButtonProps: nextButtonProps , errorMessageProps: errorMessageProps  } = $4BAFd$reactariacalendar.useRangeCalendar(props, state, domRef);
    return(/*#__PURE__*/ ($parcel$interopDefault($4BAFd$react)).createElement($6d416018158e3a26$export$bfd52a43017368fe, {
        ...props,
        state: state,
        calendarRef: domRef,
