...
function $a57fc2323bf98a33$var$Dialog(props, ref) {
    ...
    let hasHeading = $iaoFN$reactspectrumutils.useHasChild(`.${(/*@__PURE__*/$parcel$interopDefault($a74c0984b1adb651$exports))['spectrum-Dialog-heading']}`, $iaoFN$reactspectrumutils.unwrapDOMRef(gridRef));
    ...
    let hasTypeIcon = $iaoFN$reactspectrumutils.useHasChild(`.${(/*@__PURE__*/$parcel$interopDefault($a74c0984b1adb651$exports))['spectrum-Dialog-typeIcon']}`, $iaoFN$reactspectrumutils.unwrapDOMRef(gridRef));
    let slots = $iaoFN$react.useMemo(()=>({
            ...
            header: {
                UNSAFE_className: $iaoFN$reactspectrumutils.classNames((/*@__PURE__*/$parcel$interopDefault($a74c0984b1adb651$exports)), 'spectrum-Dialog-header', {
